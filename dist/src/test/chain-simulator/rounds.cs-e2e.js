...
describe('Rounds e2e tests with chain simulator', () => {
    describe('GET /rounds', () => {
        it('sgould return status code 200', async () => {
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds`);
        ...
        it('should support pagination and return 10 rounds', async () => {
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds?size=10`);
            const rounds = response.data;
            expect(response.status).toBe(200);
        ...
        it('should return filtered rounds by shard', async () => {
            const shard = 0;
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds?shard=${shard}`);
            expect(response.status).toBe(200);
        ...
        it('should return filtered rounds by epoch', async () => {
            const epoch = 2;
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds?epoch=${epoch}`);
            expect(response.status).toBe(200);
            for (const round of response.data) {
    ...
    describe('GET /rounds/count', () => {
        it('should return status code 200 and the total count of rounds', async () => {
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds/count`);
            const rounds = response.data;
            expect(response.status).toBe(200);
        ...
        it('should return filtered round count by shard', async () => {
            const shard = 0;
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds/count?shard=${shard}`);
            const rounds = response.data;
            expect(response.status).toBe(200);
            expect(typeof rounds).toBe('number');
        });
        it('should return filtered round count by epoch', async () => {
            const epoch = 2;
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds/count?epoch=${epoch}`);
            const rounds = response.data;
            expect(response.status).toBe(200);
            expect(typeof rounds).toBe('number');
        });
    ...
    describe('GET /rounds/:shard/:round', () => {
        it('should return status code 200 and round details', async () => {
            const shard = 0;
            const round = 1;
            const response = await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds/${shard}/${round}`);
        ...
        it('should return status code 404 for non-existent round ', async () => {
            ...
            const round = 999999;
            try {
                await axios_1.default.get(`${env_config_1.config.apiServiceUrl}/rounds/${shard}/${round}`);
            }
            catch (error) {
...
//# sourceMappingURL=rounds.cs-e2e.js.map