...
class UsernameUtils {
    ...
    static getContractAddress(username) {
    ...
    static extractUsernameFromRawBase64(rawUsername) {
        if (!rawUsername || rawUsername.length == 0 || !this.isBase64(rawUsername)) {
            return '';
        }
        const decodedUsername = sdk_nestjs_common_1.BinaryUtils.base64Decode(rawUsername);
...
//# sourceMappingURL=username.utils.js.map