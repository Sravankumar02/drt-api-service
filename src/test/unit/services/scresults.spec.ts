...
describe('TagService', () => {
  ...
  describe('getScResult', () => {
    it('should return smart contract details for a given smart contract hash', async () => {
      ...
      const mockIndexerScResult = {
        ...
        senderShard: 1,
        receiverShard: 1,
        data: 'RENEVFRyYW5zZmVyQDQ4NTk1MDQ1MmQzNjMxMzkzNjM2MzFAOGIzYzVhNDFhMDRhNjliMjdm',
        ...
        tokens: ['HYPE-619661'],
        dcdtValues: ['2568446286792506323583'],
  ...
  describe('getAccountScResults', () => {
    const mockIndexerScResults = [{
      ...
      timestamp: 1678983282,
      tokens: ['HYPE-619661'],
      dcdtValues: ['1000000000000000000'],
      operation: 'DCDTTransfer',
    },
    {
