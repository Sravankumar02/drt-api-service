  ...
  describe('getEvents', () => {
    it('should return a list of events with mapped fields', async () => {
      ...
      const mockElasticEvents = [
        generateMockEvent(),
        generateMockEvent({ _id: "5d4a7cd39caf55aaaef038d2fe5fd864b01db2170253c158-1-1", identifier: 'DCDTNFTCreate' }),
      ];

      const expectedEvents = [
        createExpectedEvent("7e3faa2a4ea5cfe8667f2e13eb27076b0452742dbe01044871c8ea109f73ebed", "transferValueOnly"),
        createExpectedEvent("5d4a7cd39caf55aaaef038d2fe5fd864b01db2170253c158-1-1", "DCDTNFTCreate"),
      ];
    ...
    it('should return events filtered by log address', async () => {
      const pagination: QueryPagination = { from: 0, size: 10 };
      const filter: EventsFilter = new EventsFilter({ logAddress: "drt1qqqqqqqqqqqqqpgq5lgsm8lsen2gv65gwtrs25js0ktx7ltgusrqyrucud" });
      ...
      for (const event of result) {
        expect(event.logAddress).toEqual("drt1qqqqqqqqqqqqqpgq5lgsm8lsen2gv65gwtrs25js0ktx7ltgusrqyrucud");
      }
