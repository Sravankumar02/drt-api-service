...
import { ParseAddressPipe, ParseBoolPipe, ParseArrayPipe, ParseIntPipe, ParseNftPipe, ParseCollectionPipe, ApplyComplexity, ParseAddressArrayPipe, ParseBlockHashPipe, ParseEnumPipe, ParseRecordPipe, ParseNftArrayPipe, ParseCollectionArrayPipe, ParseEnumArrayPipe } from '@sravankumar02/sdk-nestjs-common';
...
export class NftController {
  ...
  @Get("/nfts")
  @ApiOperation({ summary: 'Global NFTs', description: 'Returns a list of Non-Fungible / Semi-Fungible / MetaDCDT tokens available on blockchain' })
  ...
  @ApiQuery({ name: 'type', description: 'Filter by type (NonFungibleDCDT/SemiFungibleDCDT)', required: false })
  ...
  @ApiQuery({ name: 'withOwner', description: 'Return owner where type = NonFungibleDCDT', required: false, type: Boolean })
  @ApiQuery({ name: 'withSupply', description: 'Return supply where type = SemiFungibleDCDT', required: false, type: Boolean })
  async getNfts(
  ...
  @Get("/nfts/count")
  @ApiOperation({ summary: 'Global NFT count', description: 'Returns the total number of Non-Fungible / Semi-Fungible / MetaDCDT tokens' })
  ...
  @Get('/nfts/:identifier')
  @ApiOperation({ summary: 'NFT details', description: 'Returns the details of an Non-Fungible / Semi-Fungible / MetaDCDT token for a given identifier' })
  @ApiOkResponse({ type: Nft })
  ...
  @ApiOperation({ summary: 'NFT supply', description: 'Returns Non-Fungible / Semi-Fungible / MetaDCDT token supply details' })
  ...
  @ApiOperation({ summary: 'NFT accounts', description: 'Returns a list of addresses that hold balances for a specific Non-Fungible / Semi-Fungible / MetaDCDT token' })
  ...
  @ApiOperation({ summary: 'NFT accounts count', description: 'Returns number of addresses that hold balances for a specific Non-Fungible / Semi-Fungible / MetaDCDT token' })
  @ApiOkResponse({ type: Number })
  ...
  @ApiOperation({ summary: 'NFT transactions', description: `Returns a list of transactions for a NonFungibleDCDT or SemiFungibleDCDT.` })
  ...
  @ApiOperation({ summary: 'NFT transactions count', description: 'Returns the total number of transactions for a specific NonFungibleDCDT or SemiFungibleDCDT' })
  @ApiOkResponse({ type: Number })
  @ApiNotFoundResponse({ description: 'Token not found' })
  @ApiQuery({ name: 'sender', description: 'Address of the transaction sender', required: false })
  @ApiQuery({ name: 'receiver', description: 'Search by multiple receiver addresses, comma-separated', required: false })
  ...
  @ApiOperation({ summary: 'NFT transfers', description: `Returns a list of transfers for a NonFungibleDCDT or SemiFungibleDCDT.` })
  @ApplyComplexity({ target: TransactionDetailed })
  @ApiOkResponse({ type: [Transaction] })
  @ApiNotFoundResponse({ description: 'Token not found' })
  ...
  @ApiOperation({ summary: 'NFT transfers count', description: 'Returns the total number of transfers for a specific NonFungibleDCDT or SemiFungibleDCDT' })
  @ApiOkResponse({ type: Number })
  @ApiNotFoundResponse({ description: 'Token not found' })
