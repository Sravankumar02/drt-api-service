...
import { ParseAddressPipe, ParseArrayPipe, ParseCollectionPipe, ParseBoolPipe, ParseEnumArrayPipe, ParseIntPipe, ApplyComplexity, ParseAddressArrayPipe, ParseBlockHashPipe, ParseEnumPipe, ParseRecordPipe, ParseNftArrayPipe, ParseCollectionArrayPipe } from '@sravankumar02/sdk-nestjs-common';
...
export class CollectionController {
  ...
  @Get("/collections")
  @ApiOperation({ summary: 'Collections', description: 'Returns non-fungible/semi-fungible/meta-dcdt collections' })
  ...
  @ApiQuery({ name: 'excludeMetaDCDT', description: 'Do not include collections of type "MetaDCDT" in the response', required: false })
  ...
  @ApiOperation({ summary: 'Collection count', description: 'Returns non-fungible/semi-fungible/meta-dcdt collection count' })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  @ApiQuery({ name: 'type', description: 'Filter by type (NonFungibleDCDT/SemiFungibleDCDT/MetaDCDT)', required: false })
  @ApiQuery({ name: 'creator', description: 'Filter collections where the given address has a creator role', required: false, deprecated: true })
  @ApiQuery({ name: 'before', description: 'Return all collections before given timestamp or timestampMs', required: false, type: Number })
  ...
  @ApiOperation({ summary: 'Collection details', description: 'Returns non-fungible/semi-fungible/meta-dcdt collection details' })
  ...
  @ApiOperation({ summary: 'Collection NFTs', description: 'Returns non-fungible/semi-fungible/meta-dcdt tokens that belong to a collection' })
  ...
  @ApiOperation({ summary: 'Collection NFT count', description: 'Returns non-fungible/semi-fungible/meta-dcdt token count that belong to a collection' })
  @ApiOkResponse({ type: Number })
  @ApiNotFoundResponse({ description: 'Token collection not found' })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  @ApiQuery({ name: 'identifiers', description: 'Search by token identifiers, comma-separated', required: false })
