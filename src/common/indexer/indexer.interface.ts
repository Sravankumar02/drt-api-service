...
export interface IndexerInterface {
  ...
  getAccountDcdtByAddressesAndIdentifier(identifier: string, addresses: string[]): Promise<TokenAccount[]>
  ...
  getAccountDcdtHistory(address: string, pagination: QueryPagination, filter: AccountHistoryFilter): Promise<AccountTokenHistory[]>
  ...
  getAccountDcdtByIdentifiers(identifiers: string[], pagination?: QueryPagination): Promise<TokenAccount[]>

  getAccountsDcdtByCollection(identifiers: string[], pagination?: QueryPagination): Promise<TokenAccount[]>
