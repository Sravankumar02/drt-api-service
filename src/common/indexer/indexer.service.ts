...
export class IndexerService implements IndexerInterface {
  ...
  @LogPerformanceAsync(MetricsEvents.SetIndexerDuration)
  async getAccountDcdtByAddressesAndIdentifier(identifier: string, addresses: string[]): Promise<TokenAccount[]> {
  ...
  @LogPerformanceAsync(MetricsEvents.SetIndexerDuration)
  async getAccountDcdtHistory(address: string, pagination: QueryPagination, filter: AccountHistoryFilter): Promise<AccountTokenHistory[]> {
  ...
  @LogPerformanceAsync(MetricsEvents.SetIndexerDuration)
  async getAccountDcdtByIdentifiers(identifiers: string[], pagination?: QueryPagination): Promise<TokenAccount[]> {
    return await this.indexerInterface.getAccountDcdtByIdentifiers(identifiers, pagination);
  }

  @LogPerformanceAsync(MetricsEvents.SetIndexerDuration)
  async getAccountsDcdtByCollection(identifiers: string[], pagination?: QueryPagination): Promise<TokenAccount[]> {
